...
function AppSectionAboutUs(props) {
    const paragraphs = [
        ...
        'Only 5000 Big Cats will be minted, preserving their majesty and influence for a select few who wish to be revered in the Metaverse forever. Every Big Cat will be designed by world-class artists with savage instincts for detail, quality, and adaptability.',
            ...
            <div className={s.container}>
                ...
                <div className={s.imgContainer} >
                    <div className={s.imgBlock}>
                        <img src="/assets/big-cats/images/about-us/about.png" alt="About us" ref={$img}/>
                    </div>
