...
function AppSectionFeatures(props) {
    const paragraphs = [
        `Just like in the wild, the Metaverse is made up of predators. When compared to other NFTs, Big Cats are at the top of the food chain — no questions. The weak will be safe until the beginning of February, when the best will be chosen. From then on, the leaders will claim their dominance on the Metaverse and no one will be safe ever again.
What better way to secure your legacy in the Metaverse than with a Big Cats? Only the alphas lunge towards majesty and immortality. Take your leap now.`
    ]
            ...
            <div className={s.container}>
                <div className={s.left}>
                    <div className={s.imgBlock}>
                        <img src="/assets/big-cats/images/gallery/img-10.jpg" alt="" ref={$img}/>
                    </div>
