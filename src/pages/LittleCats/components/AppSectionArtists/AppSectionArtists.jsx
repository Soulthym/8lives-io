            ...
            <div className={s.container}>
                ...
                <div className={s.artists} ref={$imageContainer}>
                    <AppSectionArtistsCard
                        imgSrc="/assets/little-cats/images/lc-9.jpg"
                        name="Enrique Mateo-Sagasta"
                        description="Enrique has been trusted to work on culture-shifting projects like Star Wars, X-Men, and Men in Black, to name a few. His artistry will bring a quality to the Little Cats that will allow you to attract awe and envy throughout the Metaverse."
                    ...
                    />
                    <AppSectionArtistsCard
                        imgSrc="/assets/little-cats/images/lc-10.jpg"
                        name="Ricardo Cesar"
                        description="Avengers. Thor. The Fast & Furious. Aquaman. If you've ever seen these forces of nature, you've seen Ricardo's work. Ricardo is responsible for some of the most culturally significant work of the 21st century — and now he is turning his considerable attention to producing Little Cats."
